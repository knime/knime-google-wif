...
public class GoogleWIFNodeFactory extends ConfigurableNodeFactory<GoogleWIFNodeModel>
    implements NodeDialogFactory {

    private static final String FILE_INPUT_NAME = "File System Connection";
    private static final String AWS_INPUT_NAME = "AWS Connection Information";
    ...
    public NodeDialog createNodeDialog() {
        return new DefaultNodeDialog(SettingsType.MODEL, GoogleWIFSettings.class);
    }
    ...
    @Override
    protected GoogleWIFNodeModel createNodeModel(final NodeCreationConfiguration creationConfig) {
        final PortsConfiguration portsConfig = creationConfig.getPortConfig().orElseThrow();
        return new GoogleWIFNodeModel(portsConfig);
    }
    ...
    @Override
    public NodeView<GoogleWIFNodeModel> createNodeView(final int viewIndex,
        final GoogleWIFNodeModel nodeModel) {
        return null;
    }
